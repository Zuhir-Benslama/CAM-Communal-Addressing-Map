...
<qgis styleCategories="AllStyleCategories" autoRefreshMode="Disabled" simplifyDrawingHints="0" maxScale="0" symbologyReferenceScale="-1" version="3.40.3-Bratislava" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" autoRefreshTime="0" minScale="100000000" labelsEnabled="1" simplifyAlgorithm="0" simplifyLocal="1" readOnly="0">
  <flags>
  ...
  <temporal limitMode="0" durationField="" accumulate="0" startField="" durationUnit="min" enabled="0" startExpression="" endField="" fixedDuration="0" endExpression="" mode="0">
    <fixedRange>
      <start></start>
      <end></end>
    </fixedRange>
  </temporal>
  <elevation extrusion="0" respectLayerSymbol="1" extrusionEnabled="0" binding="Centroid" showMarkerSymbolInSurfacePlots="0" zscale="1" symbology="Line" zoffset="0" type="IndividualFeatures" clamping="Terrain">
    ...
    <profileLineSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" force_rhr="0" type="line" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" pass="0" id="{fe32ea46-c8cc-466d-aed6-bc9627697256}" class="SimpleLine">
          <Option type="Map">
    ...
    <profileFillSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" force_rhr="0" type="fill" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" pass="0" id="{a0160755-f775-4f05-ad85-d51e25403f42}" class="SimpleFill">
          <Option type="Map">
    ...
    <profileMarkerSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" force_rhr="0" type="marker" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" pass="0" id="{5850eed0-f871-4b02-af37-334bfa71eb21}" class="SimpleMarker">
          <Option type="Map">
  ...
  <renderer-v2 forceraster="0" enableorderby="0" referencescale="-1" type="singleSymbol" symbollevels="0">
    <symbols>
      <symbol name="0" alpha="1" clip_to_extent="1" force_rhr="0" type="marker" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" pass="0" id="{acd6128b-5474-40e4-8733-fcb486fecd8a}" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
            <Option name="color" type="QString" value="119,0,255,255,rgb:0.46666666666666667,0,1,1"/>
            <Option name="horizontal_anchor_point" type="QString" value="1"/>
            <Option name="joinstyle" type="QString" value="bevel"/>
  ...
  <selection mode="Default">
    ...
    <selectionSymbol>
      <symbol name="" alpha="1" clip_to_extent="1" force_rhr="0" type="marker" is_animated="0" frame_rate="10">
        ...
        <layer locked="0" enabled="1" pass="0" id="{825965d0-36e4-4e89-a549-31070da1722b}" class="SimpleMarker">
          <Option type="Map">
            <Option name="angle" type="QString" value="0"/>
            <Option name="cap_style" type="QString" value="square"/>
  ...
  <labeling type="simple">
    <settings calloutType="simple">
      <text-style textOpacity="1" useSubstitutions="0" textColor="119,0,255,255,rgb:0.46666666666666667,0,1,1" tabStopDistanceUnit="Percentage" blendMode="0" multilineHeightUnit="Percentage" fontSize="10" previewBkgrdColor="255,255,255,255,rgb:1,1,1,1" fontItalic="0" fontLetterSpacing="0" fontSizeMapUnitScale="3x:0,0,0,0,0,0" textOrientation="horizontal" tabStopDistanceMapUnitScale="3x:0,0,0,0,0,0" fontSizeUnit="Point" legendString="Aa" fontWordSpacing="0" forcedBold="0" fontStrikeout="0" allowHtml="0" forcedItalic="0" fontUnderline="0" fieldName="coalesce(&quot;valeur&quot;, '') || ' ' || coalesce(&quot;repetition&quot;, '')" multilineHeight="1" fontFamily="Arial" fontKerning="1" isExpression="1" capitalization="0" tabStopDistance="6" fontWeight="50" namedStyle="Normal">
        ...
        <background shapeBorderColor="128,128,128,255,rgb:0.50196078431372548,0.50196078431372548,0.50196078431372548,1" shapeOffsetY="0" shapeRadiiUnit="MM" shapeBorderWidth="0" shapeSizeType="0" shapeRadiiY="0" shapeSizeMapUnitScale="3x:0,0,0,0,0,0" shapeOpacity="1" shapeSizeUnit="MM" shapeOffsetMapUnitScale="3x:0,0,0,0,0,0" shapeFillColor="255,255,255,255,rgb:1,1,1,1" shapeSizeY="0" shapeBlendMode="0" shapeOffsetX="0" shapeSVGFile="" shapeDraw="0" shapeRadiiMapUnitScale="3x:0,0,0,0,0,0" shapeRotation="0" shapeBorderWidthMapUnitScale="3x:0,0,0,0,0,0" shapeJoinStyle="64" shapeRotationType="0" shapeOffsetUnit="MM" shapeRadiiX="0" shapeBorderWidthUnit="MM" shapeType="0" shapeSizeX="0">
          <symbol name="markerSymbol" alpha="1" clip_to_extent="1" force_rhr="0" type="marker" is_animated="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
          ...
          <symbol name="fillSymbol" alpha="1" clip_to_extent="1" force_rhr="0" type="fill" is_animated="0" frame_rate="10">
            <data_defined_properties>
              <Option type="Map">
                <Option name="name" type="QString" value=""/>
                <Option name="properties"/>
        ...
        <shadow shadowRadiusAlphaOnly="0" shadowBlendMode="6" shadowRadius="1.5" shadowColor="0,0,0,255,rgb:0,0,0,1" shadowRadiusUnit="MM" shadowRadiusMapUnitScale="3x:0,0,0,0,0,0" shadowOpacity="0.69999999999999996" shadowScale="100" shadowUnder="0" shadowOffsetAngle="135" shadowOffsetDist="1" shadowDraw="0" shadowOffsetUnit="MM" shadowOffsetMapUnitScale="3x:0,0,0,0,0,0" shadowOffsetGlobal="1"/>
        <dd_properties>
          <Option type="Map">
            <Option name="name" type="QString" value=""/>
            <Option name="properties"/>
      ...
      <text-format autoWrapLength="0" formatNumbers="0" wrapChar="" rightDirectionSymbol=">" multilineAlign="3" plussign="0" leftDirectionSymbol="&lt;" useMaxLineLengthForAutoWrap="1" reverseDirectionSymbol="0" decimals="3" placeDirectionSymbol="0" addDirectionSymbol="0"/>
      <placement maxCurvedCharAngleOut="-25" lineAnchorTextPoint="FollowPlacement" priority="5" lineAnchorType="0" lineAnchorClipping="0" prioritization="PreferCloser" repeatDistanceMapUnitScale="3x:0,0,0,0,0,0" overrunDistance="0" geometryGeneratorType="PointGeometry" centroidInside="0" layerType="PointGeometry" offsetUnits="MM" geometryGenerator="" labelOffsetMapUnitScale="3x:0,0,0,0,0,0" dist="5" rotationUnit="AngleDegrees" placementFlags="10" allowDegraded="0" geometryGeneratorEnabled="0" overrunDistanceUnit="MM" xOffset="0" repeatDistanceUnits="MM" distMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceMapUnitScale="3x:0,0,0,0,0,0" preserveRotation="1" maximumDistance="0" yOffset="0" repeatDistance="0" centroidWhole="0" distUnits="Pixel" offsetType="0" predefinedPositionOrder="TR,TL,BR,BL,R,L,TSR,BSR" placement="0" overrunDistanceMapUnitScale="3x:0,0,0,0,0,0" maximumDistanceUnit="MM" fitInPolygonOnly="0" maxCurvedCharAngleIn="25" rotationAngle="0" overlapHandling="PreventOverlap" lineAnchorPercent="0.5" polygonPlacementFlags="2" quadOffset="4"/>
      <rendering drawLabels="1" fontMinPixelSize="3" labelPerPart="0" obstacleType="1" obstacleFactor="1" unplacedVisibility="0" upsidedownLabels="0" fontMaxPixelSize="10000" limitNumLabels="0" maxNumLabels="2000" mergeLines="0" minFeatureSize="0" scaleMax="0" obstacle="1" zIndex="0" scaleMin="0" fontLimitPixelSize="0" scaleVisibility="0"/>
      <dd_properties>
        <Option type="Map">
          <Option name="name" type="QString" value=""/>
          <Option name="properties"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <attributeEditorForm>
    <labelStyle overrideLabelColor="0" labelColor="" overrideLabelFont="0">
      <labelFont bold="0" underline="0" strikethrough="0" description="MS Shell Dlg 2,8.25,-1,5,50,0,0,0,0,0" italic="0" style=""/>
    </labelStyle>
    <attributeEditorField index="1" name="valeur" verticalStretch="0" horizontalStretch="0" showLabel="1">
      <labelStyle overrideLabelColor="0" labelColor="" overrideLabelFont="0">
        <labelFont bold="0" underline="0" strikethrough="0" description="MS Shell Dlg 2,8.3,-1,5,50,0,0,0,0,0" italic="0" style=""/>
      </labelStyle>
    </attributeEditorField>
    <attributeEditorField index="-1" name="Prefix" verticalStretch="0" horizontalStretch="0" showLabel="1">
      <labelStyle overrideLabelColor="0" labelColor="" overrideLabelFont="0">
        <labelFont bold="0" underline="0" strikethrough="0" description="MS Shell Dlg 2,8.3,-1,5,50,0,0,0,0,0" italic="0" style=""/>
      </labelStyle>
    </attributeEditorField>
